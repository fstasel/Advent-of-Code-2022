I did not add a period calculator code. By the observation of dellist variable and after some trials, I realized that we have a flat ground in a period. So, I just wrote the codes to work for that case.
